...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const semanticItemTagClasses = 'semantic-item-tag inline-block bg-indigo-100 text-indigo-700 px-3 py-1.5 text-sm sm:text-base rounded-md font-sans mx-0.5 my-1 shadow-sm hover:bg-indigo-200 transition-colors'; // Slightly increased base for tags within semantic analysis
