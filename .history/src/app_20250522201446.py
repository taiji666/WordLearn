...
@app.get("/remember.html") # NEW ROUTE
async def remember_page(request: Request, topicId: str | None = Query(None)):
    return templates.TemplateResponse(
        "remember.html",
        {"request": request, "topicId": topicId} # topicId used by remember.js & script.js (for sidebar)
    )
